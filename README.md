...
if your mobile phone is on android system, and other system based on android, you can use app:droidcam to work.  
    ...
    2)install droidcam on your pc(on ubuntu, install packages is provided in folder "droidcam" ) .
		3)use usb or same wifi to connect your pc and phone.
